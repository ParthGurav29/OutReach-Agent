...
export default function Sidebar({ history, onView, onRerun }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "14px", borderBottom: "1px solid #e2e8f0", display: "flex", alignItems: "center", justifyContent: collapsed ? "center" : "space-between" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              {history.map(entry => (
                <div key={entry.id} style={{
                  background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "8px", padding: "12px", display: "flex", flexDirection: "column", gap: "8px",
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <span style={{ fontSize: "11px", background: "#f8fafc", color: "#4f46e5", padding: "2px 8px", borderRadius: "999px", fontWeight: "600" }}>{entry.totalLeads || entry.prospectsFound || 0} leads</span>
                  </div>
                  ...
                  <div style={{ display: "flex", gap: "8px", marginTop: "4px" }}>
                    <button onClick={() => onView(entry)} style={{ flex: 1, padding: "6px", background: "#ffffff", border: "1px solid #e2e8f0", color: "#64748b", fontSize: "11px", borderRadius: "6px", cursor: "pointer", transition: "all 0.1s" }} onMouseEnter={e => e.target.style.background = "#f8fafc"} onMouseLeave={e => e.target.style.background = "#ffffff"}>View</button>
